define(["TFS/Work/RestClient","TFS/WorkItemTracking/RestClient","TFS/WorkItemTracking/Services"], function(__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(1), __webpack_require__(2), __webpack_require__(3), __webpack_require__(4), __webpack_require__(6), __webpack_require__(7)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, RestClient, RestClientWI, WorkItemServices, tc, telemetryClientSettings, moment) {
	    ...
	    var WidgetWIProperty = (function () {
	        ...
	        WidgetWIProperty.prototype.LoadWI = function (widgetSettings) {
	            ...
	            if (customSettings) {
	                ...
	                this.clientwi.getWorkItem(customSettings.wiId).then(function (wi) {
	                    ...
	                    _this.DisplayWI(wi, customSettings.wiPropertyName, customSettings.wiColorPropertyName, customSettings.color, customSettings.title, customSettings.dateFormat);
	                    $("#loadingwidget").hide();
	                    $("#content").show();
	                    $("#wi-title").dotdotdot();
	                    $("#wi-desc").dotdotdot();
	        ...
	        WidgetWIProperty.prototype.DisplayWI = function (wi, fieldname, colorfield, colorstring, titlestring, dateFormat) {
	        ...
	        WidgetWIProperty.prototype.isValidDate = function (date) {
	            return date && Object.prototype.toString.call(date) === "[object Date]" && !isNaN(date);
	        };
	        WidgetWIProperty.prototype.noHtml = function (txt) {
	            var a = txt.indexOf("<");
	            var b = txt.indexOf(">");
	            var len = txt.length;
	        ...
	        WidgetWIProperty.prototype.getWorkItemColor = function (workItemType) {
	            var witColor = "";
	            switch (workItemType) {
	                case "AMBER":
	                    witColor = "#ffbf00";
	        ...
	        WidgetWIProperty.prototype.getStateColor = function (state) {
	            var statecolor = "";
	            switch (state) {
	                case "Approved":
	                case "New":
	        ...
	        WidgetWIProperty.prototype.DeltaDate = function (date) {
	            var now = Date.now();
	        ...
	        WidgetWIProperty.prototype.getMemberAvatarUrl = function (memberIdentity) {
	        ...
	        WidgetWIProperty.prototype.load = function (widgetSettings) {
	            return this.LoadWI(widgetSettings);
	        };
	        WidgetWIProperty.prototype.reload = function (widgetSettings) {
	            return this.LoadWI(widgetSettings);
	        };
	        return WidgetWIProperty;
	    }());
	    exports.WidgetWIProperty = WidgetWIProperty;
	    VSS.require("TFS/Dashboards/WidgetHelpers", function (WidgetHelpers) {
	        WidgetHelpers.IncludeWidgetStyles();
	        VSS.register("wipropertywidget", function () {
	            var widgetProperty = new WidgetWIProperty(WidgetHelpers);
